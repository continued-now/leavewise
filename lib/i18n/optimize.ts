export const t = {
  en: {
    ...
    planLimitReached: 'Plan limit reached (10)',
    noSavedPlans: 'No saved plans yet',
    noSavedPlansDesc: 'Run an optimization and save it to see it here.',
    replaceCurrentPlan: 'Replace current results?',
    selectTwoToCompare: 'Select 2 plans to compare',
  ...
  ko: {
    ...
    deletePlan: '삭제',
    comparePlans: '비교하기',
    planSaved: '플랜이 저장되었습니다',
    planDeleted: '플랜이 삭제되었습니다',
    planLoaded: '플랜을 불러왔습니다',
    planLimitReached: '플랜 제한 도달 (10개)',
    noSavedPlans: '저장된 플랜이 없습니다',
    noSavedPlansDesc: '최적화를 실행하고 저장하면 여기에 표시됩니다.',
    replaceCurrentPlan: '현재 결과를 대체하시겠습니까?',
    selectTwoToCompare: '비교할 2개의 플랜을 선택하세요',
